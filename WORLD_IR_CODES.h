...
const uint16_t code_eu140Times[] PROGMEM = {
  448, 448,
  56, 168,
  56, 56,
  56, 4526,
...
const uint8_t code_eu140Codes[] PROGMEM = {
  0x15,
  0xAA,
  0x95,
  0xAA,
...
//-to confirm this, go to http://cdecl.org/ and paste "const int* const NApowerCodes[] PROGMEM", and you'll 
